...
export class StatusBoxComponent {
  ...
  myObjects : MyDataObject[] = [
    new MyDataObject( '71,028 ' , 'EGP' , 'Total Value' , '2%' , 'rete-down', ''),
    new MyDataObject( '20,000' , 'm' , 'Total Sales' , '50 m' , 'rete-up', '3'),
    new MyDataObject( '20,000' , 'm' , 'Avg Sales' , '50 m' , 'rete-down', '3'),
